<template>
  <div class="statistic-dashboard-safety dashboard-full-screen">
    ...
    <div class="statistic-dashboard-main">
      ...
      <div class="main-item item-attendance-right">
        <div class="title-wrap">
          <div class="title"><span class="icon" />安全周报</div>
    ...
    <div class="statistic-dashboard-footer">
      ...
      <div class="footer-item footer-item-2">
        <div class="title-wrap">
          <div class="title"><span class="icon" />安全隐患统计</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    fetchGetTrend(projectId) {
      getTrend({ type: 2, projectId }).then((data) => {
    ...
    fetchSituation(projectId) {
      situation({ type: 2, projectId, model: 1 }).then((data) => {
        if (data && data.code === 1000) {
    ...
    fetchQuestionByCon(projectId) {
      questionByCon({ type: 2, projectId }).then((data) => {
        if (data && data.code === 1000) {
    ...
    fetchQuestionByType(projectId) {
      questionByType({ type: 2, projectId }).then((data) => {
        if (data && data.code === 1000) {
...
.statistic-dashboard-safety {
  ...
  .statistic-dashboard-main {
    ...
    .title-wrap {
      ...
      .title {
        ...
        .icon {
          ...
          background: url('../../../assets/statistic-dashboard/safe.png') center no-repeat no-repeat;
          background-size: 100% 100%;
          width: 1.38rem;
          height: 1.54rem;
    ...
    .item-attendance-center {
      ...
      .center-main {
        position: relative;
        background: url('../../../assets/statistic-dashboard/s-center-bg.png') center no-repeat no-repeat;
        background-size: 100% 100%;
        width: 31.31rem;
        height: 20rem;
        margin: 0 auto;
