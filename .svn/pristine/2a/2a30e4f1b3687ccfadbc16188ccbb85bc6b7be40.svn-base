<template>
  <div class="zhgd-sys-dict-type">
    <el-form :inline="true" :model="dataForm">
      <el-form-item prop="dictName">
        <el-input v-model="dataForm.dictName" placeholder="名称" clearable />
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button type="text" style="color: rgb(254, 27, 54);" size="small" @click="deleteHandle(scope.row.dictId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
import { getList, del } from '@/api-zhgd/sys/dict-type'
