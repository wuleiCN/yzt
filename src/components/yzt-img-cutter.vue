            ...
            <div ref="dialogMainModalRef" :class="isModal===true?'dialogMainModal':'dialogMain'" :style="'width:'+(isModal===true?boxWidth+32:boxWidth) + 'px'">
              <div class="toolMain">
                ...
                >
                  ...
                  <!--工具栏-->
                  <div v-if="tool==true" v-show="drawImg.img && dropImg.active!==true && controlBox.disable==true && toolBox.disable==true" class="dockMain" :style="'background:'+ toolBgc" @mouseenter="dropImgOff">
              ...
              <div class="i-dialog-footer">
                <input ref="inputFile" type="file" accept="image/gif, image/jpeg ,image/png" style="width:1px;height:1px;border:none;opacity: 0;" @change="putImgToCanv">
...
export default {
  ...
  methods: {
    handleOpen: function(img) {
      ...
      const init = (callback) => {
        ...
        if (_this.isModal === true) {
          ...
          const dialogBoxHeight = _this.$refs['dialogMainModalRef'].offsetHeight + 200
          const windowHeight = window.innerHeight
          const mask = _this.$refs['mask']
    ...
    importImgToCanv: function(img) {
      ...
      const boxWidth = _this.boxWidth
      const boxHeight = _this.boxHeight
      let rate
      const drawImg = { ..._this.drawImg }
      drawImg.img = img
