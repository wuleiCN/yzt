          ...
          <el-col :span="15">
            <el-form v-if="showForm" ref="dataForm" :model="dataForm" :rules="dataRule" label-width="120px">
              ...
              <el-form-item
                ...
                :label="platformName === 'AJD' ? '地区编码' : platformName === 'SHAANXI' ? 'provider' : ['HZZJJ', 'GDJY', 'GDJM'].includes(platformName) ? '厂家识别码' : '设备序号'"
                prop="clientSerial"
              >
                <el-input
                  v-model.trim="dataForm.clientSerial"
                  :placeholder="platformName === 'AJD' ? '地区编码' : platformName === 'SHAANXI' ? 'provider' : ['HZZJJ', 'GDJY', 'GDJM'].includes(platformName) ? '厂家识别码' : '设备序号'"
                />
              </el-form-item>
