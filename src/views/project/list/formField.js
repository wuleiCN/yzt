export const Strategy = (function() {
  const DiscountMap = {
    ...
    clientSerial: function() { // 设备序号 或 厂家识别码
      return ['HZBL', 'SCZIYANG', 'XINGHE', 'JIANGMEN', 'ZHUAN', 'QINGNINGHUDONG', 'GDMEIZHOU', 'ZJJH', 'WANKE', 'FJS', 'STZZ', 'DONGWAN', 'HENAN', 'ZJKG', 'XMJF', 'GXGJT', 'SHANXI', 'WUHAN', 'ZHENGZHOU', 'HAOFENG', 'TANGCAI', 'HAOFENGYS', 'QUANGUO', 'GUANGZHOUSW', 'GDQINGYUAN', 'LWSMZ', 'RENYUANSMZ', 'SHPDXM']
    }
  }
