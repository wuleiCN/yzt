export const Strategy = (function() {
  const DiscountMap = {
    projectNumber: function() { // 项目同步编号
      return ['HZBL', 'XINGHE', 'HZZJJ', 'ZJJH', 'GDJY', 'STZZ', 'DONGWAN', 'HENAN', 'GXGJT', 'WUHAN', 'SHAANXI', 'ZHENGZHOU', 'QINGNINGHUDONG', 'RENYUANSMZ']
    },
    ...
    userName: function() { // 登录账号
      return ['AJD', 'HZBL', 'SCZIYANG', 'XINGHE', 'JIANGMEN', 'ZHUAN', 'ZHONGYEYUN', 'QINGNINGHUDONG', 'GDMEIZHOU', 'FJS', 'WANKE', 'STZZ', 'DONGWAN', 'ZJKG', 'XMJF', 'GXGJT', 'SHANXI', 'WUHAN', 'HAOFENG', 'TANGCAI', 'HAOFENGYS', 'ZHENGZHOU', 'QUANGUO', 'GUANGZHOUSW', 'GDQINGYUAN', 'LWSMZ', 'RENYUANSMZ']
    },
    ...
    clientSerial: function() { // 设备序号 或 厂家识别码
      return ['HZBL', 'SCZIYANG', 'XINGHE', 'JIANGMEN', 'ZHUAN', 'QINGNINGHUDONG', 'GDMEIZHOU', 'ZJJH', 'WANKE', 'FJS', 'STZZ', 'DONGWAN', 'HENAN', 'ZJKG', 'XMJF', 'GXGJT', 'SHANXI', 'WUHAN', 'ZHENGZHOU', 'HAOFENG', 'TANGCAI', 'HAOFENGYS', 'QUANGUO', 'GUANGZHOUSW', 'GDQINGYUAN', 'LWSMZ', 'RENYUANSMZ']
    }
  }
