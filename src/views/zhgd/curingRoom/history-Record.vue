<template>
  <div class="zhgd-material-history">
    <el-form :inline="true" :model="dataForm">
      ...
      <el-form-item prop="isControl">
        <el-select v-model.trim="dataForm.type" clearable style="width:100%" placeholder="分组类别" @change="searchHandle">
          <el-option label="1" :value="0"> 1# </el-option>
          <el-option label="2" :value="8"> 2#</el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
