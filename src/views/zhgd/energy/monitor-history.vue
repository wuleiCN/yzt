...
<script>
import { getRecord } from '@/api-zhgd/water-meter'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      yearEndTime: '',
      dataList: [],
      exportUrl: `/waterRecord/exportWaterRecord?token=${token}`,
  ...
  methods: {
    ...
    getDataList(deviceId) {
      ...
      this.exportUrl = `/waterRecord/exportWaterRecord?deviceId=${deviceId}&query=${this.btnVal}`
