<template>
  <div class="mataerial-smoke-sensor">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.devType === 1">在线</span>
          <span v-if="scope.row.devType === 2">离线</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="devType"
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.devType === 1">0</span>
          <span v-if="scope.row.devType === 2">1</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="installDate"
