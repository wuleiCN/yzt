...
import { getList, del } from '@/api-zhgd/box-device'
import { boxProList } from '@/api-zhgd/box-monitor'
...
export default {
  ...
  async created() {
    this.proList = await this.boxProListHandle()
