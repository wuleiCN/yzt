  ...
  <div class="transfer">
    <div>
      <div class="transfer-title">
        <el-checkbox v-model="checkAll" style="display:inline-block" :indeterminate="isIndeterminate" @change="handleCheckAllChange" /> <span>未选中参建</span>
    ...
    <div>
      <div class="transfer-title">
        <el-checkbox v-model="checkAll1" style="display:inline-block" :indeterminate="isIndeterminate1" @change="handleCheckAllChange1" /> <span>选中参建</span>
      ...
      <el-checkbox-group v-model="rightCheckList" class="left-style" @change="handleCheckedCitiesChange1">
        ...
        <div v-for="(item,index) in rightData" :key="index"> <el-checkbox :label="item.id">{{ item.construction.constructionName }}</el-checkbox></div>
      </el-checkbox-group>
    </div>
  </div>
</template>
